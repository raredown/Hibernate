...
//        IPersonaDAO adao = daof.getPersonaDAO();
        ...
        switch (request.getParameter("op")) {
            case "add":
                ...
                libros.add(libro1);
                Libro libro2 = new Libro("La Celestina");
                libros.add(libro2);
                persona = new Persona("lara", libros);
//
//                try {
...
//                profesor.setDireccion(direccion);
                ...
                break;
            case "delete":
                persona = (Persona)gdao.getOne(Integer.parseInt(request.getParameter("registro")), Persona.class);
//                persona = adao.getOne(Integer.parseInt(request.getParameter("registro")));
                gdao.delete(persona);
                url = "index.html";
                break;
//            case "update":
